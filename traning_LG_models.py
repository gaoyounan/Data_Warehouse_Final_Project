...
lr = LogisticRegression(labelCol="label", regParam=0.3, elasticNetParam=0.8, featuresCol="features", maxIter=1000)
...
pipelineFit.write().overwrite().save("piplineLGModel")
